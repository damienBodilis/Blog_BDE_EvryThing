<?php
// src/EvryThing/BlogBundle/Entity/Enquiry.php
...
$metadata->addPropertyConstraint('email', new Email(array('message'=>'Merci de renseigner une adresse mail correcte.','checkMX' => true)));
